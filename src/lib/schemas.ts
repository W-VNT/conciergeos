...
export const incidentSchema = z.object({
  ...
  category: z.enum(['PLOMBERIE', 'ELECTRICITE', 'SERRURERIE', 'NUISIBLES', 'ELECTROMENAGER', 'CHAUFFAGE_CLIM', 'DEGATS_DES_EAUX', 'BRUIT_VOISINAGE', 'NETTOYAGE', 'AUTRE']).default('AUTRE'),
